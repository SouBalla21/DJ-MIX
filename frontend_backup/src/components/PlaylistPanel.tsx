...
/** PlaylistPanel component – displays, creates and deletes pla
export default function PlaylistPanel() {
  ...
  const fetchPlaylists = async () => {
    ...
    try {
      ...
      // Assume API returns an array of playlist objects compat
  ...
  return (
    <div style={{ border: "1px solid #ccc", padding: "1rem", ma
      <h3>Playlists</h3>

      {/* New playlist form */}
      <form onSubmit={handleCreate} style={{ marginBottom: "1re
        <input
          type="text"
